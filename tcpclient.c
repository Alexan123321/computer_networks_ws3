...
int main() {
    ...
    socketDescriptor = socket(AF_INET, SOCK_STREAM, 0);                         //AF_INET is denoting the IPv4 address family, where SOCK_DGRAM denotes the datagram-based protocol, UDP.                           
    ...
    connect(socketDescriptor, (const struct sockaddr*) &serverAddress, sizeof(serverAddress));
